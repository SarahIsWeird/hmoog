...
export const ACTIVATING_HARDLINE_MESSAGE = '<color=#9B9B9BFF>-activating hardline-</color>';
...
export const HARDLINE_ALREADY_ACTIVE_MESSAGE = '<color=#FF0000FF>:::TRUST COMMUNICATION:::</color> hardline is already active.';
